...
module UltimateTurboModal::Flavors
  class Tailwind < UltimateTurboModal::Base
    ...
    DRAWER_CONTENT_CLASSES = [
      "relative flex h-full w-full flex-col overflow-y-auto bg-white py-6 shadow-xl dark:bg-gray-800 dark:text-white"
    ].join(" ")
    ...
    DRAWER_MAIN_CLASSES = "relative mt-6 flex-1 group-data-[padding=true]:px-4 group-data-[padding=true]:sm:px-6"
